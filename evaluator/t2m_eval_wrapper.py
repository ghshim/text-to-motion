...
from evaluator.t2m_eval_modules import *
...
def build_models(opt):
    ...
    checkpoint = torch.load(pjoin('evaluator', 'text_mot_match', 'model', 'finest.tar'),
...
class EvaluatorModelWrapper(object):
    ...
    def __init__(self, opt):
        ...
        if opt.dataset_name == 'tm' or opt.dataset_name == 't2m':
            opt.dim_pose = 263
